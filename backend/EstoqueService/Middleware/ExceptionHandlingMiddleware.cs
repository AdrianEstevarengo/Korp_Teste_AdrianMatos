...
/// <summary>
/// Centraliza o tratamento de erros/exceções do backend, convertendo exceções
/// de domínio em respostas HTTP com corpo padronizado (ProblemDetails-like).
/// </summary>
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            await EscreverAsync(context, StatusCodes.Status500InternalServerError,
                "Erro interno", "Ocorreu um erro inesperado no serviço de Estoque.");
        }
    }
